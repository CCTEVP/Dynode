const scrapper = {
   ...
   * @returns Promise<{ components: string[], libraries: string[], assets: string[] }>
   */
  async getComponents(
    content: string
  ): Promise<{ components: string[]; libraries: string[]; assets: string[] }> {
    ...
    function recurse(obj: any) {
      if (obj && typeof obj === "object") {
        ...
        if (
          ...
          libraries.add(obj.type + obj.animation);
        }
