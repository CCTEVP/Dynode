...
| -------------------------------------------------------------------------- | ------------------------------------------- |
| **[🔐 AUTHENTICATION-GUIDE.md](documents/AUTHENTICATION-GUIDE.md)**        | **Authentication setup and security guide** |
| **[QUICK-REFERENCE.md](documents/QUICK-REFERENCE.md)**                     | Quick start guide for creating rooms        |
| **[ROOM-HANDLER-GUIDE.md](documents/ROOM-HANDLER-GUIDE.md)**               | Complete API reference and examples         |
| **[ROOM-ARCHITECTURE-SUMMARY.md](documents/ROOM-ARCHITECTURE-SUMMARY.md)** | Architecture overview and benefits          |
| **[ARCHITECTURE-DIAGRAM.md](documents/ARCHITECTURE-DIAGRAM.md)**           | Visual diagrams of the architecture         |
| **[QUICKSTART-ROOMS.md](documents/QUICKSTART-ROOMS.md)**                   | Basic room usage examples                   |
...
See **[QUICK-REFERENCE.md](documents/QUICK-REFERENCE.md)** for more details.
